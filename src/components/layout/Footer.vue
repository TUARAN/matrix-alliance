    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><router-link to="/tasks" class="text-gray-400 hover:text-white transition-colors">任务市场</router-link></li>
            <li><router-link to="/content" class="text-gray-400 hover:text-white transition-colors">内容工厂</router-link></li>
            <li><router-link to="/distribution" class="text-gray-400 hover:text-white transition-colors">分发中心</router-link></li>
            <li><router-link to="/analytics" class="text-gray-400 hover:text-white transition-colors">数据分析</router-link></li>
          </ul>
        </div>
